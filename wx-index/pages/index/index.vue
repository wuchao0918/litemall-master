<template>
	<view class="container">
		...
		<view class="cate-item">
			<image src="/static/temp/book1.png" background-Color="#1bca4c"></image>
			<text>社区书屋</text>
		</view>
		...
		<view class="cate-section">
			...
			<view class="cate-item">
			<image src="/static/temp/shangmeng.png"></image>
			<text>权益商圈</text>
		</view>
		<view class="cate-item">
		...
		<view class="cate-item">
			<image src="/static/temp/yuyue.png"></image>
			<text>金融预约</text>
		</view>
		...
		<view class="ad-1">
			<image src="/static/temp/huodong.jpg" mode="scaleToFill"></image>
		</view>
		...
		<view class="f-header m-t">
			...
			<view class="tit-box">
				<text class="tit">小区理财顾问</text>
				<text class="tit2">Your identity financial advisor</text>
			</view>
