  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        <el-form-item label="图书ISBN" prop="goodsSn">
        ...
        <el-form-item label="是否有库存" prop="isOnSale">
        ...
        <el-form-item label="单位">
          <el-input v-model="goods.unit" placeholder="本"/>
        </el-form-item>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="products">
        <el-table-column property="value" label="图书规格">
          <template slot-scope="scope">
        ...
        <el-table-column property="price" width="100" label="图书积分"/>
        <el-table-column property="number" width="100" label="图书数量"/>
        <el-table-column property="url" width="100" label="图书图片">
          <template slot-scope="scope">
      ...
      <el-dialog :visible.sync="productVisiable" title="设置图书">
        <el-form
          ref="productForm"
          :model="productForm"
          status-icon
          ...
          label-width="100px"
          style="width: 400px; margin-left:50px;">
          <el-form-item label="图书规格列" prop="specifications">
            <el-tag v-for="tag in productForm.specifications" :key="tag">
              {{ tag }}
            </el-tag>
          </el-form-item>
          <el-form-item label="图书积分" prop="price">
            <el-input v-model="productForm.price"/>
          </el-form-item>
          <el-form-item label="图书数量" prop="number">
            <el-input v-model="productForm.number"/>
          </el-form-item>
          <el-form-item label="图书图片" prop="url">
            <el-upload
              :action="uploadPath"
              :show-file-list="false"
              :headers="headers"
    ...
    <!--<el-card class="box-card">
      ...
      <el-table :data="attributes">
        <el-table-column property="attribute" label="图书参数名称"/>
        <el-table-column property="value" label="图书参数值"/>
        <el-table-column align="center" label="操作" width="100" class-name="small-padding fixed-width">
          <template slot-scope="scope">
      ...
      <el-dialog :visible.sync="attributeVisiable" title="设置图书参数">
        <el-form
          ref="attributeForm"
          :model="attributeForm"
          status-icon
          ...
          label-width="100px"
          style="width: 400px; margin-left:50px;">
          <el-form-item label="图书参数名称" prop="attribute">
            <el-input v-model="attributeForm.attribute"/>
          </el-form-item>
          <el-form-item label="图书参数值" prop="value">
