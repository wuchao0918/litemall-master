...
//        infos.put("快递鸟ID", environment.getProperty("litemall.express.appId"));
        ...
        infos.put("书店名称", SystemConfig.getMallName());
        ...
        infos.put("后台管理界面，请在Terminal下执行 ","cd litemall-admin  npm run dev");
        infos.put("前台通用信息配置文件 ","cd litemall-core/src/main/java/org/");
        return infos;
    }
}
